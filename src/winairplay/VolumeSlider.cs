...
internal sealed class VolumeSlider : Control
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        using var track = new Pen(Theme.Border, 4) { StartCap = LineCap.Round, EndCap = LineCap.Round };
        using var fill = new Pen(Theme.Accent, 4) { StartCap = LineCap.Round, EndCap = LineCap.Round };
        ...
        e.Graphics.FillEllipse(thumb, x - 7, center - 7, 14, 14);
